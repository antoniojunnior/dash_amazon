                          ...
                          {order.items?.map((item: any, idx: number) => {
                            ...
                            return (
                              <div key={idx} className="flex items-start gap-4 group/item">
                                ...
                                <div className="min-w-0">
                                  <p className={`text-label-md font-black line-clamp-2 max-w-[420px] transition-colors leading-tight ${isSyncing ? 'text-on-surface-variant/30 italic' : 'text-on-surface group-hover/item:text-primary'}`}>
                                    {item.title}
                                  </p>
